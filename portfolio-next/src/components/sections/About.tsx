...
const techData = {
  ...
  'Next.js': { Icon: SiNextdotjs, experience: 'Expertise en App Router, Server Components, y optimización de rendimiento (ISR, SSG).', years: '1 año' },
  ...
  Figma: { Icon: FaFigma, experience: 'Diseño de prototipos interactivos, mockups de alta fidelidad y sistemas de diseño para una UX consistente.', years: '1 año' },
