// types.ts (opcional, puedes definirlo en el mismo archivo)
...
export default function Tecnologias() {
    ...
    return (
        ...
        <section>
            ...
            <div>
                <h2 className="justify-center items-center m-auto text-center">Tecnologias</h2>
                ...
                >
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 2.2, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1, repeatType: "mirror", }}
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 2.3, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1 }}
                    >

                        <div className='w-max-7 h-max-7'>
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 2.4, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1 }}
                    >
                        <div className='w-max-7 h-max-7'>
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 2.7, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1 }}
                    >
                        <div>
                            <svg viewBox="0 0 128 128">
                                <path fill="url(#a)" d="M66.958.825a6.07 6.07 0 0 0-6.035 0L11.103 29.76c-1.895 1.072-2.96 3.095-2.96 5.24v57.988c0 2.143 1.183 4.167 2.958 5.24l49.82 28.934a6.07 6.07 0 0 0 6.036 0l49.82-28.935c1.894-1.072 2.958-3.096 2.958-5.24V35c0-2.144-1.183-4.167-2.958-5.24z"></path><path fill="url(#b)" d="M116.897 29.76 66.841.825A8.161 8.161 0 0 0 65.302.23L9.21 96.798a6.251 6.251 0 0 0 1.657 1.43l50.057 28.934c1.42.833 3.076 1.072 4.615.595l52.66-96.925a3.702 3.702 0 0 0-1.302-1.072z"></path><path fill="url(#c)" d="M116.898 98.225c1.42-.833 2.485-2.262 2.958-3.81L65.066.108c-1.42-.238-2.959-.119-4.26.715L11.104 29.639l53.606 98.355c.71-.12 1.54-.358 2.25-.715z"></path><defs><linearGradient id="a" x1="34.513" x2="27.157" y1="15.535" y2="30.448" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop stop-color="oklch(36.397% 0.19078 303.39)"></stop><stop offset=".33" stop-color="oklch(36.397% 0.19078 303.39)"></stop><stop offset=".637" stop-color="oklch(49.6% 0.265 301.924)"></stop><stop offset=".934" stop-color="oklch(54.845% 0.28963 302.021)"></stop><stop offset="1" stop-color="oklch(54.845% 0.28963 302.021)"></stop></linearGradient><linearGradient id="b" x1="30.009" x2="50.533" y1="23.359" y2="8.288" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop offset=".138" stop-color="oklch(36.397% 0.19078 303.39)"></stop><stop offset=".402" stop-color="oklch(54.845% 0.28963 302.021)"></stop><stop offset=".713" stop-color="oklch(36.397% 0.19078 303.39)"></stop><stop offset=".908" stop-color="oklch(36.397% 0.19078 303.39)"></stop></linearGradient><linearGradient id="c" x1="21.917" x2="40.555" y1="22.261" y2="22.261" gradientTransform="translate(-129.242 -73.715) scale(6.18523)" gradientUnits="userSpaceOnUse"><stop offset=".092" stop-color="oklch(49.6% 0.265 301.924)"></stop><stop offset=".287" stop-color="oklch(49.6% 0.265 301.924)"></stop><stop offset=".598" stop-color="oklch(36.397% 0.19078 303.39"></stop><stop offset=".862" stop-color="oklch(29.357% 0.15351 303.829"></stop></linearGradient></defs>
                            </svg>
                        </div>
                        <div className='text-sm font-bold'>
                            <p>Node.js</p>
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 3.1, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1 }}
                    >
                        <div>

                            <svg viewBox="0 0 128 128">
                                <path fill="oklch(49.6% 0.265 301.924)" d="M2 1v125h125V1H2zm66.119 106.513c-1.845 3.749-5.367 6.212-9.448 7.401-6.271 1.44-12.269.619-16.731-2.059-2.986-1.832-5.318-4.652-6.901-7.901l9.52-5.83c.083.035.333.487.667 1.071 1.214 2.034 2.261 3.474 4.319 4.485 2.022.69 6.461 1.131 8.175-2.427 1.047-1.81.714-7.628.714-14.065C58.433 78.073 58.48 68 58.48 58h11.709c0 11 .06 21.418 0 32.152.025 6.58.596 12.446-2.07 17.361zm48.574-3.308c-4.07 13.922-26.762 14.374-35.83 5.176-1.916-2.165-3.117-3.296-4.26-5.795 4.819-2.772 4.819-2.772 9.508-5.485 2.547 3.915 4.902 6.068 9.139 6.949 5.748.702 11.531-1.273 10.234-7.378-1.333-4.986-11.77-6.199-18.873-11.531-7.211-4.843-8.901-16.611-2.975-23.335 1.975-2.487 5.343-4.343 8.877-5.235l3.688-.477c7.081-.143 11.507 1.727 14.756 5.355.904.916 1.642 1.904 3.022 4.045-3.772 2.404-3.76 2.381-9.163 5.879-1.154-2.486-3.069-4.046-5.093-4.724-3.142-.952-7.104.083-7.926 3.403-.285 1.023-.226 1.975.227 3.665 1.273 2.903 5.545 4.165 9.377 5.926 11.031 4.474 14.756 9.271 15.672 14.981.882 4.916-.213 8.105-.38 8.581z"></path>
                            </svg>
                    ...
                    <motion.span className='w-auto flex items-center gap-3 bg-violet-950 border-2 border-purple-700 rounded-4xl p-1 px-4 font-sans'
                        initial={{ scale: 1 }}
                        animate={{ translateY: [0, -10, 0], }}
                        transition={{ delay: 3.2, duration: 0.5, repeat: Infinity, ease: "easeInOut", repeatDelay: 1 }}
                    >
                        <div>

                            <svg viewBox="0 0 128 128">
                                <path fill='oklch(49.6% 0.265 301.924)' d="M64.002 8.576 128 119.424H0Zm0 0"></path>
                            </svg>
