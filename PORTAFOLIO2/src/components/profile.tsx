                ...
                <div className='flex flex-wrap w-fit mt-2 gap-2'>
                    ...
                    <div className='flex-wrap flex items-center gap-3 h-max-8'>
                        <motion.a href="mailto:dev.moisesmarcano@gmail.com"
                            ...
                            whileTap={{ scale: 0.95 }}
                        ><button className='hover:cursor-pointer hover:bg-purple-600   hover:outline-2 hover:outline-purple-500 hover:outline-offset-2px flex-wrap flex items-center gap-3 bg-accent rounded-4xl p-0.5 px-2 font-sans text-lg'><Mail />dev.moisesmarcano@gmail.com</button></motion.a>
